...
We used the [Stackoverflow API](https://api.stackexchange.com/docs) to gather this information, using our own code.
We searched for all issues with taggins of either `playframework` or `spring-mvc`. 
