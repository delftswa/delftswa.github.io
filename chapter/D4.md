#Metrics
This section describes the quality of the software, using the [GMQ](http://www.im-institute.org/gqm/gqm%20guide%20non%20printable.pdf). 
...
##Questions
In this section, three question will be formulated that focus on characterising the assessment or achievement of the goal that has been defined in the section above.
...
Scalability is an important aspect for a web development framework that aim to support large web applications. 
...
The higher the throughput, the more requests is may be able to handle per unit of time.
...
A lot of tests have been performed between the most commonly used web development frameworks. 
...
#####Time per request
Latency is a relevant metric for web applications, because it tells a lot about the efficiency of handling a request. 
...
There is also a notable difference between the Scala and Java version of Play Framework.
The root cause of this phenomenon is the [efficient scalability](http://architects.dzone.com/articles/scaling-scala-vs-java) (by James Roper) of the Scala Programming Language.
