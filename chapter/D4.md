...
The root cause of this phenomenon is the [efficient scalability](http://architects.dzone.com/articles/scaling-scala-vs-java) (by James Roper) of the Scala Programming Language, this allows the Scala language to be more efficient.

Judging from these graphs, we can see that the Play Framework performs constantly well on the metrics.
With the exeption of a few versions.
