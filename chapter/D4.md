# Outline
- [Draft chapter](/chapter/D5-draft.md)
- Metrics: 
  - [Goal](#goal)
  - [Question 1: Maintainability](#maintainability), [Question 2: Scalability](#scalability), [Question 3: Adoption](#Adoption)
  - Metrics on [Maintainability](#maintainability-1), [Scalability](#scalability-1), [Adoption](#adoption-1)
...
![GQM diagram](images/gqm.png)
<!--- 
	You can adopt the diagram on this page, please update the gqm.png snapshot.
http://www.nomnoml.com/#view/%0A[Goal]%0A[Goal]->[Scalability]%0A[Goal]->[Maintainability]%0A[Goal]->[Adoption]%0A[Scalability]->[Resources%20per%20request]%0A[Scalability]->[Throughput]%0A[Maintainability]->[Module%20size%20LOC/module]%0A[Maintainability]->[Module%20size%20over%20time]%0A[Maintainability]->[#Spin-off%20modules]%0A[Maintainability]->[#Test%20Coverage]%0A[Adoption]->[Stackoverflow%20questions]%0A[Adoption]->[Job%20positions]%0A
-->
...
Play offers built in horizontal scaling principles, for example that it is stateless by nature. 
...
* 2.400 requests/second in a test performed by [Christian Papauschek](http://blog.papauschek.com/2013/04/real-world-performance-of-the-play-framework-on-ec2/) in 2013. In this test, a Play 2.1.1-scala production instance running on EC2 large was used to service complete web pages.
...
![](./images/simple_request.png)
_Simple plain text request_

![](./images/50k_chuck.png)
_50kbit request_
...
contribute, new features can be added and potential bugs might be fixed 
...
![Module Size over time (LOC)](images/modules-over-time.png).
...
![Histogram Play](images/frequenogramStackoverflow.png)
The histogram above shows all months up until the last month (march 2015).
...
Assuming that number of questions asked gives a good estimate of adaptation, 
we can infer that both frameworks have quite some adaptation, with more than 200 and 750 questions per month, respectively.
...
Of course many other causes for this can exist too, other than adaptation. Play might be documented so well that little questions need to be asked. 
...
**Entity:** Play Framework
<br>**Attribute:** adoption
<br>**Mapping:** count number of job openings
<br>**Measure:** number
<br>**Scale:** non-negative integer (ratio)
...
![job openings barchart](images/job.png)
...
![Extra skill pie chart](images/extraSkill.png)
