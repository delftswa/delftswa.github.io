...
The idea behind this question is that the amount of questions on [Stackoverflow](http://stackoverflow.com) reflects the usage of the Play Framework.
...
To gather data for this metric we used the [Stackoverflow API](https://api.stackexchange.com/docs), using our own code. We searched for all issues tagged with either `playframework` or `spring-mvc`. The resulting ____ questions are plotted this metric on the following chart.
