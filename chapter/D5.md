...
<!-- TODO : write alinea instead of bullet list, explain how Play does these things -->
<!-- refer to earlier sections where needed -->
<!-- as from Rozanski, to be extended: -->
<!-- can copy parts from earlier work -->
<!-- see: https://www.playframework.com/documentation/2.3.x/Translations#Deploying-documentation-to-playframework.com -->

- software configuration management (Ivy(/Maven))
- automated build process
- automated testing
- continuous integration (=> Plays own documatation is updated every 10 minutes!)
