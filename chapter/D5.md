...
That Play has less questions could mean that the usage of Play is more clear than Spring.
...
Especially for javascript frameworks there is a vast demand.
The demand for Play developers is reletively low, but still there is a considerable amount of demand.
Especially compared to another Scala web framework, Scalatra.
